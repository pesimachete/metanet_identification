...
import Variational_paraMetanet.MCMC_based.simulator.parametanet as parametanet
...
def generate_ar1_parameters_unconstrained(
    ...
    noise = jnp.zeros((3, N))
    initial_noise = innovations[:, 0] / jnp.sqrt(1 - zeta**2)
    noise = noise.at[:, 0].set(initial_noise)
